...
def Update():
    ...
    for i in range(t):
        ...
        x = 0
        r_gain, which_task, which_partition, stop = Gain_cal(test_array, t, moved_task, x)
       # print(f"random_gain={r_gain}")
    ...
    #print("LAST Solution",Final_Array)
    #print(f"Last Energy COST is:{Final_cost}")
